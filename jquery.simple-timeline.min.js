...
"</a></div>").insertAfter(e).find("a").click(function(){b.expandAll=!b.expandAll;j.toggle(!b.expandAll);c("a",e).removeClass(b.actClass);c(this).html(b.expandAll?b.expandAllText[0]:b.expandAllText[1]);return!1}))}})}})(jQuery);